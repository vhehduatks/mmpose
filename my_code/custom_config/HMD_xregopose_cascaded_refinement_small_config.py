"""
Cascaded Pose Refinement Head - Smoke Test (Small Dataset)
...
Smoke test: 2 epochs, small dataset, no checkpoint saving.
"""
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_cascaded_refinement_small'),
...
work_dir = 'work_dirs/HMD_xregopose_cascaded_refinement_small'
