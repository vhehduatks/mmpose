# Task 8.3 cross-training fold 1: paper config UNCHANGED except the train
# data_root (symlink tree excluding this fold's participants) and work_dir.
# Fold membership matches the FRAME repo's ours_part1.yaml exactly.
"""
...
if IS_WINDOWS:
    ...
    data_root_train = '/mnt/dataset_vol/kinect_v5_folds/part1_train'  # Task 8.3: fold 1 (FRAME's ours_part1 val participants held out)
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_ground_info_10ep_fold1'
