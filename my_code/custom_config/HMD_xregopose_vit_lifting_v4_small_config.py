"""
ViT-Style Lifting Head v4 - CosineAnnealingLR (Smoke Test)

v3 대비 변경점:
- MultiStepLR → CosineAnnealingLR (부드러운 LR 감소)
- 급격한 LR decay로 인한 validation spike 방지

Architecture: v3와 동일
- Learnable Joint Queries + Self-Attention
- Heatmap Reconstruction Regularization
- HMD Cross-Attention
"""
...
# =============================================================================
# Training Config - Smoke Test (2 epochs to see LR effect)
# =============================================================================
...
train_cfg = dict(
    ...
    max_epochs=2,  # 2 epochs to observe LR schedule
    val_interval=1,
)
val_cfg = dict()
test_cfg = None
...
# =============================================================================
# Model - ViT-Style Lifting v4 (same as v3, different LR schedule)
# =============================================================================
model = dict(
...
work_dir = 'work_dirs/HMD_xregopose_vit_lifting_v4_small'
