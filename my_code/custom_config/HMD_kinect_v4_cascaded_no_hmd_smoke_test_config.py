"""
Kinect v4 Cascaded Refinement + No-HMD Smoke Test (vision-only)
...
model = dict(
    ...
    head=dict(
        ...
        in_channels=2048,
        out_channels=16,
        hmd_info_size=9,  # 9-dim (zeros input)
...
work_dir = 'work_dirs/HMD_kinect_v4_cascaded_no_hmd_smoke_test'
