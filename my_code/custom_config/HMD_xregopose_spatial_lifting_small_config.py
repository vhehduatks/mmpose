"""
Phase 5-D: Spatial Lifting with Grid Sampling - Smoke Test Config
...
- Per-joint depth features instead of global pooling
...
model = dict(
    ...
    head=dict(
        ...
        # Spatial depth extractor config (NEW!)
...
work_dir = 'work_dirs/HMD_xregopose_spatial_lifting_small'
