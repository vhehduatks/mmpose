"""
Attention Z Encoder Head - Smoke Test Config
...
# =============================================================================
# Hooks - No checkpoint for smoke test
# =============================================================================
default_hooks = dict(
    checkpoint=None,
    visualization=dict(
...
work_dir = 'work_dirs/HMD_xregopose_attention_z_encoder_small'
