"""
Cascaded architecture, vision-only (no HMD input). ZeroHMDInfo zeros out the 9-dim HMD vector.
For fair comparison with methods that use only images.
"""
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_cascaded_no_hmd'),
...
work_dir = 'work_dirs/HMD_xregopose_cascaded_no_hmd'
