"""
egodataset_flag_fixed_ver5 - Cascaded Refinement V2b + LHF only - RUN 4 (10 epochs)
- 4th run of HMD_kinect_v5_flag_cascaded_lhf_only_10ep_config.py.
  Identical settings (same seed, schedule, hyperparams); fresh work_dir/wandb name
  so RUN 1 / RUN 2 / RUN 3 checkpoints are preserved. Variance comes from non-deterministic CUDA ops.
- For paper TABLE V: Cascaded + LHF column (variance / reproducibility check).
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='HMD_kinect_v5_flag_cascaded_lhf_only_run4_10ep',
            tags=['kinect_v5_flag', 'cascaded', 'lhf_only', 'run4', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_lhf_only_run4_10ep'
