"""Task 18a — attention in stage 2: gated attention residual on the
headline checkpoint (see ours_a_modules.py). Fine-tune: backbone+stage1
frozen, 5 ep AdamW 1e-4, MultiStepLR [3,4]x0.5. Init == headline
digit-for-digit (GATE 18-0c). Variants override model.head.attn_mode /
use_hmd_token.

Launch:
    PYTHONPATH=$PWD \
    /home/.conda/envs/mmpose/bin/python tools/train.py \
        my_code/custom_config/HMD_kinect_v5_ours_a_config.py \
        --work-dir work_dirs/ours_a_full
"""
