"""
egodataset_flag_fixed_ver5 - Cascaded Refinement V2b + Image-only (10 epochs)
- For paper TABLE V: Cascaded + Image-only column
- Apples-to-apples sibling of HMD_kinect_v5_flag_cascaded_gbh_only_10ep_config.py:
  ...
  same schedule, only the HMD input differs — all HMD dims zeroed.
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='HMD_kinect_v5_flag_cascaded_image_only_10ep',
            tags=['kinect_v5_flag', 'cascaded', 'image_only', 'no_hmd', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_image_only_10ep'
