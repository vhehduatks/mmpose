"""
Attention-based Lifting Head v3 - SMOKE TEST Config
- LR 0.001 (2x of v1)
- MultiStepLR (same as v1)
- Gradient clipping
...
# LR Schedule: MultiStepLR (simplified for 1 epoch)
param_scheduler = [
    dict(
        type='MultiStepLR',
        begin=0,
...
work_dir = 'work_dirs/HMD_xregopose_attention_lifting_v3_small'
