"""
preprocessing_egodataset_weightmodify_intrinsic_ver3_blend - Cascaded Refinement V2b + Ground Info 12-dim (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='preprocessing_egodataset_weightmodify_intrinsic_ver3_blend-cascaded-ground-info-12dim',
            name='HMD_kinect_v3_cascaded_ground_info_20ep',
            tags=['kinect_v3', 'cascaded_ground_info', '20ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v3_cascaded_ground_info_20ep'
