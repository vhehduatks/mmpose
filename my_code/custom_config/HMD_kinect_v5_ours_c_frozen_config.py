"""Task 15.2 - frozen stage 2 fed the STF1-fused coarse (no training; val/dump only)."""
"""
...
# =============================================================================
data_mode = 'topdown'
dataset_type = 'KinectEgoposeFusedDataset'
fused_root = '/mnt/dataset_vol/preds_coarse_stf1'
