"""
Mo2Cap2 Baseline - With Ground Reference + Lower LR (0.00025)

Ablation: Compare LR=0.0005 vs LR=0.00025 for baseline model.

HMD Info: 12-dim (9 base + 3 ground reference)
Learning Rate: 0.00025 (same as cascaded V2)
...
# Lower learning rate (same as cascaded V2)
optim_wrapper = dict(
...
# Model: Baseline head with hmd_info_size=12 (with ground reference)
model = dict(
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='baseline_with_ground_lr0.00025',
            tags=['mo2cap2', 'baseline', 'with_ground', 'lr_ablation'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_mo2cap2_baseline_with_ground_lr'
