"""
preprocessing_egodataset_weightmodify_intrinsic_ver3_blend - Cascaded Refinement V2b + No-HMD (vision-only) (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='preprocessing_egodataset_weightmodify_intrinsic_ver3_blend-cascaded-no-hmd',
            name='HMD_kinect_v3_cascaded_no_hmd_20ep',
            tags=['kinect_v3', 'cascaded_no_hmd', '20ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v3_cascaded_no_hmd_20ep'
