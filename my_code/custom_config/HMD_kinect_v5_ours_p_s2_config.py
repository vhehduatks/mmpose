"""Task 14a - Ours-P (s2): stage-2 pure pinhole (final = ray*(z_coarse+dd)).
Headline 10-ep recipe, warm-started from the headline checkpoint."""
"""
...
custom_imports = dict(
    imports=['my_code.custom_config.ours_p_modules'],
    allow_failed_imports=False,
)

# Task 14: fine-tune the pinhole reparametrization from the headline ckpt
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_ground_info_10ep'
