"""
egodataset_flag_fixed_ver5 - Single-Stage + Ground Info 12-dim (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='egodataset_flag_fixed_ver5-ground-info-12dim',
            name='HMD_kinect_v5_flag_ground_info_10ep',
            tags=['kinect_v5_flag', 'ground_info', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_ground_info_10ep'
