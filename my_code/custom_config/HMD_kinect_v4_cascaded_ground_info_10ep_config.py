"""
Kinect v4 Cascaded Refinement + Ground Info 10-epoch (12-dim HMD)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='kinect-cascaded-ground-info-12dim',
            name=f'kinect_v4_cascaded_ground_info_{_max_epochs}ep',
            tags=['kinect', 'cascaded', 'ground_info', '12dim_hmd', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v4_cascaded_ground_info_10ep'
