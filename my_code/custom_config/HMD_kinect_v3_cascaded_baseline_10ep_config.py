"""
preprocessing_egodataset_weightmodify_intrinsic_ver3 - Cascaded Refinement V2b + Baseline 9-dim (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='kinect_v3-cascaded-baseline-9dim',
            name='HMD_kinect_v3_cascaded_baseline_10ep',
            tags=['kinect_v3', 'cascaded_baseline', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v3_cascaded_baseline_10ep'
