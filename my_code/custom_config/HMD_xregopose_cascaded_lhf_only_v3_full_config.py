...
- Task 36 R1: LHF-only (9-dim base from the h5; EnhanceHMDInfo removed)
...
model = dict(
    ...
    head=dict(
        ...
        in_channels=2048,
        out_channels=16,
        hmd_info_size=9,  # Task 36 R1: LHF base only, no GBH heights
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_t36_lhf_only'),
...
work_dir = 'work_dirs/HMD_xregopose_cascaded_lhf_only_v3_full'
