...
# Data paths
# =============================================================================
_kinect_root = r'C:\Program Files\Azure-Kinect-Samples\body-tracking-samples\scripts\kinect_smoke_test_dataset'

if IS_WINDOWS:
    data_root_train = _kinect_root + r'\Train'
    data_root_test = _kinect_root + r'\Test'
    pretrained_coco = r'F:\egodataset_cache\pose_coco\coco_pose_resnet_101_256x192.pth.tar'
else:
    data_root_train = '/mnt/dataset_vol/kinect_smoke_test_dataset/Train'
    data_root_test = '/mnt/dataset_vol/kinect_smoke_test_dataset/Test'
...
default_hooks = dict(
    checkpoint=None,  # No saving for smoke test
    visualization=dict(
        enable=True,
        interval=50,
        kpt_thr=0.3,
...
# =============================================================================
# Model - Single COCO Backbone (same as baseline)
# =============================================================================
model = dict(
...
# =============================================================================
# Pipeline (standard file-based image loading)
# =============================================================================
_meta_keys = (
...
if IS_WINDOWS:
    ...
    _batch_size = 8  # Smaller batch: 1920x1080 images are larger
else:
    _num_workers = 4
...
# =============================================================================
# Visualization (no wandb for smoke test)
# =============================================================================
vis_backends = [
...
work_dir = 'work_dirs/HMD_kinect_v4_smoke_test'
