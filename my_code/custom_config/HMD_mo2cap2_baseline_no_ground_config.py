"""
Mo2Cap2 Baseline - NO Ground Reference (9-dim HMD)

Ablation: Compare with ground reference version to measure impact of ground info.
...
Architecture: Backbone -> Deconv -> Heatmap -> Encoder (with HMD) -> Pose Decoder -> 3D
"""
...
# Model: Baseline head with hmd_info_size=9 (NO ground reference)
model = dict(
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='baseline_no_ground',
            tags=['mo2cap2', 'baseline', 'no_ground', 'ablation'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_mo2cap2_baseline_no_ground'
