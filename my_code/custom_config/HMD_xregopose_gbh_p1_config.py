"""Task 38 P1 (xr) — derived from HMD_xregopose_cascaded_both_from_ground_v3_full_config.py; changes: head arm params + work_dir only.
"""
"""
...
work_dir = 'work_dirs/HMD_xregopose_gbh_p1'
