"""
preprocessing_egodataset_weightmodify_intrinsic_ver3 - Cascaded Refinement V2b + Ground Info 12-dim (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='kinect_v3-cascaded-ground-info-12dim',
            name='HMD_kinect_v3_cascaded_ground_info_10ep',
            tags=['kinect_v3', 'cascaded_ground_info', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v3_cascaded_ground_info_10ep'
