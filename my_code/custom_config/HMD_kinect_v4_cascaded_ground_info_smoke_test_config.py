"""
Kinect v4 Cascaded Refinement + Ground Info Smoke Test (12-dim HMD)
...
# =============================================================================
# Model - Cascaded Refinement + Enhanced HMD (12-dim, with ground info)
# =============================================================================
model = dict(
    ...
    head=dict(
        ...
        heatmap_decoder_type='efficient',  # V2b EfficientHeatmapDecoder
        decoder=codec,
        # Stage 1 losses
        loss=dict(
            loss_weight=1000,
...
work_dir = 'work_dirs/HMD_kinect_v4_cascaded_ground_info_smoke_test'
