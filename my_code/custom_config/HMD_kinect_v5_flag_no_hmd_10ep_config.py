"""
egodataset_flag_fixed_ver5 - Single-Stage + No-HMD (vision-only) (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='egodataset_flag_fixed_ver5-no-hmd-vision-only',
            name='HMD_kinect_v5_flag_no_hmd_10ep',
            tags=['kinect_v5_flag', 'no_hmd', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_no_hmd_10ep'
