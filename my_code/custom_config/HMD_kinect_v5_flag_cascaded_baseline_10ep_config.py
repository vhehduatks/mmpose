"""
egodataset_flag_fixed_ver5 - Cascaded Refinement V2b + Baseline 9-dim (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='egodataset_flag_fixed_ver5-cascaded-baseline-9dim',
            name='HMD_kinect_v5_flag_cascaded_baseline_10ep',
            tags=['kinect_v5_flag', 'cascaded_baseline', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_baseline_10ep'
