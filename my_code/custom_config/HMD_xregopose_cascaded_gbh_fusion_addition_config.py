"""
Fusion ablation: element-wise addition (default, 64-dim output)

Cascaded + GBH (12-dim) on xR-EgoPose.
Fusion mode: addition
"""
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_fusion_ablation_addition'),
...
work_dir = 'work_dirs/HMD_xregopose_fusion_addition'
