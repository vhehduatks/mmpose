"""
egodataset_flag_fixed_ver5 - Cascaded Stage 1 Only + LHF 9-dim (10 epochs)
- For paper TABLE V: Single-stage + LHF row
- Uses CascadedRefinementHead_enhanced with use_refinement=False (Stage 2 disabled)
- LHF = Localized HMD Feature only (9-dim, no ground-based heights)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='egodataset_flag_fixed_ver5-cascaded-stage1-only-baseline-9dim',
            name='HMD_kinect_v5_flag_cascaded_stage1_only_baseline_10ep',
            tags=['kinect_v5_flag', 'cascaded_stage1_only', 'baseline_9dim', 'LHF', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_stage1_only_baseline_10ep'
