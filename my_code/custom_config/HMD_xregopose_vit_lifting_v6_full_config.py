"""
ViT Lifting v6 - Small Dataset Optimized (Full Training Config)
...
Expected improvements over v3:
    - More stable training (less validation spikes)
    - Better generalization with reduced params
    - Locality bias helps with 210K dataset
...
# =============================================================================
# Model - ViT Lifting v6 (Small Dataset Optimized)
# =============================================================================
model = dict(
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_vit_lifting_v6'),
...
work_dir = 'work_dirs/HMD_xregopose_vit_lifting_v6_full'
