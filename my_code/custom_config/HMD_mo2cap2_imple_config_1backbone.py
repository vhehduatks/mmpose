...
# ann_file_test = '/dataset/cross_plat/mo2cap2_data_half/TestSet'
# ann_file_val = '/dataset/cross_plat/mo2cap2_data_half/ValSet'
# ann_file_train = '/dataset/cross_plat/mo2cap2_data_half/TrainSet'
# # ---
# # mo2cap2 dataset train all, test all
ann_file_test = '/dataset/extracted_mo2cap2_dataset/TestSet'
ann_file_train = '/dataset/extracted_mo2cap2_dataset/TrainSet'
