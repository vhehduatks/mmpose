"""
Fusion ablation: concatenation → projection to 64-dim

Cascaded + GBH (12-dim) on xR-EgoPose.
Fusion mode: concat_64
"""
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_fusion_ablation_concat64'),
...
work_dir = 'work_dirs/HMD_xregopose_fusion_concat64'
