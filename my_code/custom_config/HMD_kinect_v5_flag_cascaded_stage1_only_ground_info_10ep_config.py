"""
egodataset_flag_fixed_ver5 - Cascaded Stage 1 Only + Ground Info 12-dim (10 epochs)
- Uses CascadedRefinementHead_enhanced with use_refinement=False (Stage 2 disabled)
- For paper results table: fair comparison of Stage 1 architecture with/without refinement
...
model = dict(
    ...
    head=dict(
        ...
        out_channels=16,
        hmd_info_size=12,
        use_refinement=False,  # Stage 2 disabled (Stage 1 only)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='egodataset_flag_fixed_ver5-cascaded-stage1-only-ground-info-12dim',
            name='HMD_kinect_v5_flag_cascaded_stage1_only_ground_info_10ep',
            tags=['kinect_v5_flag', 'cascaded_stage1_only', 'ground_info', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_stage1_only_ground_info_10ep'
