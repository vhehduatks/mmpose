"""
Kinect v4 Cascaded Refinement + Baseline 10-epoch (9-dim HMD)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='kinect-cascaded-baseline-9dim',
            name=f'kinect_v4_cascaded_baseline_{_max_epochs}ep',
            tags=['kinect', 'cascaded', 'baseline', '9dim_hmd', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v4_cascaded_baseline_10ep'
