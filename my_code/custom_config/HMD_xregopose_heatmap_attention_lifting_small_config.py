"""
Per-Joint Heatmap Attention Lifting - Smoke Test Config
...
Key improvement over Global Attention:
...
work_dir = 'work_dirs/HMD_xregopose_heatmap_attention_lifting_small'
