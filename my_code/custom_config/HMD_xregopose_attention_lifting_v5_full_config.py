"""
Attention-based Lifting Head v5 - Higher LR (0.002) + CosineAnnealing
- LR 0.002 (2x of v4, 4x of v1)
- CosineAnnealing (no warmup)
- Gradient clipping (max_norm=1.0)

Previous results:
- v1 (LR=0.0005, MultiStepLR): 45.43mm at epoch 7
- v2 (LR=0.0005, Warmup+Cosine): 48.38mm at epoch 8
- v3 (LR=0.001, MultiStepLR): 46.68mm at epoch 1, then diverged
- v4 (LR=0.001, CosineAnnealing): 47.95mm at epoch 6, epoch 1: 76.12mm (slow start)

v5 Hypothesis:
- v4's slow start (76.12mm at epoch 1) was due to CosineAnnealing reducing LR too early
- Higher LR (0.002) should compensate for CosineAnnealing's decay
- Expected: Fast initial convergence (like v3) + stable decay (like v4)
"""
...
# =============================================================================
# Training Config - Higher LR (0.002) + CosineAnnealing
# =============================================================================
...
# Optimizer: LR=0.002 (2x of v4) + Gradient Clipping
optim_wrapper = dict(
    optimizer=dict(lr=0.002, type='AdamW', weight_decay=0.01),
    clip_grad=dict(max_norm=1.0, norm_type=2),
)

# LR Schedule: CosineAnnealing WITHOUT warmup
param_scheduler = [
    dict(
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_attention_lifting_v5'),
...
work_dir = 'work_dirs/HMD_xregopose_attention_lifting_v5_full'
