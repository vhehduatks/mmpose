"""
Mo2Cap2 Cascaded Refinement + BOTH FROM GROUND V3b (Asymmetric Loss + Higher LR)

V3 Asymmetric Loss with higher learning rate.

Changes from V3:
  - lr: 0.00025 → 0.0005 (double)
...
# V3b: Higher learning rate (0.0005)
optim_wrapper = dict(
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='cascaded_v3b_asymmetric_lr0.0005',
            tags=['mo2cap2', 'cascaded', 'asymmetric_loss', 'v3b', 'lr_ablation'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_mo2cap2_cascaded_both_from_ground_v3b'
