# Task 8.3 cross-training fold 3: paper config UNCHANGED except the train
# data_root (symlink tree excluding this fold's participants) and work_dir.
# Fold membership matches the FRAME repo's ours_part3.yaml exactly.
"""
egodataset_flag_fixed_ver5 - Cascaded Refinement V2b + Ground Info 12-dim (10 epochs)
...
if IS_WINDOWS:
    ...
    data_root_train = '/mnt/dataset_vol/kinect_v5_folds/part3_train'  # Task 8.3: fold 3 (FRAME's ours_part3 val participants held out)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            tags=['kinect_v5_flag', 'cascaded_ground_info', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_ground_info_10ep_fold3'
