"""
Global Context Enhanced Attention Lifting - Full Training Config
...
- Global context provides inter-joint relationships
- Attention can learn when to use global vs local cues
- Better handling of occluded/ambiguous joints
"""
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_global_attention'),
...
work_dir = 'work_dirs/HMD_xregopose_global_attention_lifting_full'
