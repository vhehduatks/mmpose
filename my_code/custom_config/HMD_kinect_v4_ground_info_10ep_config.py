"""
Kinect v4 Ground Info 10-epoch Config (12-dim HMD, with ground info)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            tags=['kinect', 'ground_info', '12dim_hmd', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v4_ground_info_10ep'
