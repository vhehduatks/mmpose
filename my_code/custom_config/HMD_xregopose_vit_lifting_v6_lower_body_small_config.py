"""
ViT Lifting v6 + Lower Body Enhancement (Smoke Test Config)

Smoke test for new losses: bone_length_loss, pose_l2norm_weighted, symmetry_loss
"""
...
# =============================================================================
# Training Config - Smoke Test (1 epoch, no checkpoint)
# =============================================================================
...
work_dir = 'work_dirs/HMD_xregopose_vit_lifting_v6_lower_body_small'
