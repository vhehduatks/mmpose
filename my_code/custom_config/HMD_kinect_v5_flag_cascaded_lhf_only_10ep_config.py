"""
egodataset_flag_fixed_ver5 - Cascaded Refinement V2b + LHF only (10 epochs)
- For paper TABLE V: Cascaded + LHF column (re-run, parallel naming with
...
- Apples-to-apples sibling of HMD_kinect_v5_flag_cascaded_gbh_only_10ep_config.py:
  ...
  same schedule, only the HMD input differs — LHF dims kept, no GBH heights.
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='egodataset_flag_fixed_ver5-cascaded-lhf-only',
            name='HMD_kinect_v5_flag_cascaded_lhf_only_10ep',
            tags=['kinect_v5_flag', 'cascaded', 'lhf_only', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_lhf_only_10ep'
