"""
ViT-Style Lifting Head v5 - Hybrid Attention (Smoke Test)
...
Architecture:
    ...
    Joint Tokens [16, D]
         │
         ├── Heatmap Decoder (scaled gradient 0.1)
         ↓
    ┌─────────────────────────────────────────┐
...
# =============================================================================
# Training Config - Smoke Test (2 epochs)
# =============================================================================
...
work_dir = 'work_dirs/HMD_xregopose_vit_lifting_v5_small'
