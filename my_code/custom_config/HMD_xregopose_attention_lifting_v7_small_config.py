"""
Attention-based Lifting Head v7 - Smoke Test Config
...
v7 Schedule (same as full config):
- LR=0.0005 (v1's optimal)
- Short iter warmup (500 iters, 0.5x→1x)
- MultiStepLR [3, 5, 7] (earlier decay than v1)
...
# =============================================================================
# Optimizer: v1's LR + Gradient Clipping (same as full)
# =============================================================================
optim_wrapper = dict(
...
param_scheduler = [
    dict(
        ...
        by_epoch=False,
        begin=0,
        end=50,  # Shorter for small dataset
    ),
]
...
work_dir = 'work_dirs/HMD_xregopose_attention_lifting_v7_small'
