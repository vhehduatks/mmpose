"""
egodataset_flag_fixed_ver5 - Cascaded Refinement V2b + LHF only - RUN 7 (10 epochs)
- 7th run of HMD_kinect_v5_flag_cascaded_lhf_only_10ep_config.py.
  Identical settings (same seed, schedule, hyperparams); fresh work_dir/wandb name
  so RUN 1-6 checkpoints are preserved. Variance comes from non-deterministic CUDA ops.
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='HMD_kinect_v5_flag_cascaded_lhf_only_run7_10ep',
            tags=['kinect_v5_flag', 'cascaded', 'lhf_only', 'run7', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_lhf_only_run7_10ep'
