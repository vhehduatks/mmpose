"""
HMD Attention Fusion + Both From Ground (12 dims) - SMOKE TEST

Small config for quick verification of training pipeline.
Uses reduced dataset and epochs.
"""
...
train_cfg = dict(
    ...
    max_epochs=2,  # Short training for smoke test
    val_interval=1,
)
val_cfg = dict()
test_cfg = None
...
work_dir = 'work_dirs/HMD_xregopose_hmd_attention_fusion_both_from_ground_small'
