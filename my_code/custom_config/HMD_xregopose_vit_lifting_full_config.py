"""
ViT-Style Lifting Head v2 - Full Training Config (Reconstruction Regularized)
...
│  - Joint ↔ Joint (skeleton prior)                          │
│         ↓                                                   │
│  Joint Tokens [16, D]                                       │
│         │                                                   │
│         ├→ Heatmap Decoder → Recon Heatmap (loss)          │
│         │   (forces 2D joint info into tokens)              │
│         ↓                                                   │
...
- It INJECTS 2D joint information into the joint tokens
- Tokens enriched with 2D info → HMD adds 3D → better 3D pose

LR Schedule: Based on Attention Lifting v1-v7 analysis
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_vit_lifting'),
...
work_dir = 'work_dirs/HMD_xregopose_vit_lifting_full'
