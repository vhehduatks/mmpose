...
Derived from HMD_kinect_v5_flag_cascaded_ground_info_10ep_config.py; ONLY the four loss weights and work_dir/wandb names change.
"""
IS_WINDOWS = False
_batch_size = 16
_max_epochs = 10
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_gbh_noslosses_10ep'
