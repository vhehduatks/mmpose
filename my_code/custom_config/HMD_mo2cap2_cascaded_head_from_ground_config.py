"""
Mo2Cap2 Cascaded Refinement + HEAD FROM GROUND (Body-Axis Method)

Model: Cascaded Refinement with Enhanced HMD (10-dim: 9 base + 1 head ground ref)
...
# Model: hmd_info_size=10 (9 base + 1 head_from_ground)
model = dict(
...
# Pipeline with head_from_ground mode
train_pipeline = [
    ...
    dict(type='EnhanceHMDInfo_Mo2Cap2', mode='head_from_ground'),
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='cascaded_HEAD_from_ground_bodyaxis',
            tags=['mo2cap2', 'cascaded', 'head_from_ground', 'body_axis_fix'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_mo2cap2_cascaded_head_from_ground'
