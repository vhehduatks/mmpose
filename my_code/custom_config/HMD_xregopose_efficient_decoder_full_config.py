"""
Efficient HeatmapDecoder Full Training Config
- EfficientHeatmapDecoder (1.35M params) vs Original HeatmapDecoder (40M params)
...
model = dict(
    ...
    head=dict(
        ...
        heatmap_decoder_type='efficient',  # <<< EfficientHeatmapDecoder (1.35M vs 40M)
    ),
    test_cfg=dict(
        flip_test=False,
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_efficient_decoder'),
...
work_dir = 'work_dirs/HMD_xregopose_efficient_decoder_full'
