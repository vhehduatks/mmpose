"""
egodataset_flag_fixed_ver5 - Cascaded Refinement V2b + Image-only - RUN 6 (10 epochs)
- 6th run of HMD_kinect_v5_flag_cascaded_image_only_10ep_config.py.
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='HMD_kinect_v5_flag_cascaded_image_only_run6_10ep',
            tags=['kinect_v5_flag', 'cascaded', 'image_only', 'no_hmd', 'run6', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v5_flag_cascaded_image_only_run6_10ep'
