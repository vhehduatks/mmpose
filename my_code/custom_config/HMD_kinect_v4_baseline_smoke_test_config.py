"""
Kinect v4 Baseline Smoke Test Config (9-dim HMD, no ground info)
...
# =============================================================================
# Model - Baseline (9-dim HMD, no ground info)
# =============================================================================
model = dict(
    ...
    head=dict(
        ...
        out_channels=16,
        type='CustomxRegoposeBaselinel1'  # hmd_info_size=9 (hardcoded)
    ),
    test_cfg=dict(
        flip_test=False,
...
# =============================================================================
# Dataset Config - NO ground info (ground_info_mode=None → 9-dim)
# =============================================================================
data_mode = 'topdown'
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='kinect-baseline-9dim',
            name=f'kinect_v4_baseline_9dim_{_max_epochs}ep',
            tags=['kinect', 'baseline', '9dim_hmd', 'smoke_test'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v4_baseline_smoke_test'
