"""
Phase 5-C: Lifting + Backbone Feature Fusion - Smoke Test Config
...
# =============================================================================
# Training Config - 5 epochs for meaningful test
# =============================================================================
...
train_cfg = dict(
    ...
    max_epochs=1,  # Smoke test: 1 epoch only
    val_interval=1,
)
val_cfg = dict()
test_cfg = None
...
param_scheduler = []  # No scheduler for 1 epoch

default_hooks = dict(
    checkpoint=dict(
        save_best=None,  # No checkpoint saving
        type='CheckpointHook',
        interval=999,  # Effectively disabled
    ),
    visualization=dict(
        enable=False,
...
model = dict(
    ...
    head=dict(
        ...
        # Backbone encoder config (for depth cues)
...
# =============================================================================
# Visualization (Local only for quick test)
# =============================================================================
vis_backends = [
...
work_dir = 'work_dirs/HMD_xregopose_lifting_backbone_fusion_small'
