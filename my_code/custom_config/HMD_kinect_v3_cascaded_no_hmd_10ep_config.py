"""
preprocessing_egodataset_weightmodify_intrinsic_ver3 - Cascaded Refinement V2b + No-HMD (vision-only) (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='kinect_v3-cascaded-no-hmd',
            name='HMD_kinect_v3_cascaded_no_hmd_10ep',
            tags=['kinect_v3', 'cascaded_no_hmd', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v3_cascaded_no_hmd_10ep'
