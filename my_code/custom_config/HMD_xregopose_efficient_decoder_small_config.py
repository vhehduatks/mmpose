"""
Efficient HeatmapDecoder Smoke Test Config (Small)
- Tests EfficientHeatmapDecoder (1.35M params) vs Original (40M params)
- Short training: 2 epochs for verification
"""
...
# =============================================================================
# Training Config - Short for smoke test
# =============================================================================
...
# =============================================================================
# Model - Single COCO Backbone with EFFICIENT HeatmapDecoder
# =============================================================================
model = dict(
    ...
    head=dict(
        ...
        heatmap_decoder_type='efficient',  # <<< Use EfficientHeatmapDecoder (1.35M vs 40M)
    ),
    test_cfg=dict(
        flip_test=False,
...
# =============================================================================
# Visualization - Disable wandb for smoke test
# =============================================================================
vis_backends = [
...
work_dir = 'work_dirs/HMD_xregopose_efficient_decoder_small'
