"""
Fusion ablation: concatenation 128-dim (no projection)

Cascaded + GBH (12-dim) on xR-EgoPose.
Fusion mode: concat_128
"""
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_fusion_ablation_concat128'),
...
work_dir = 'work_dirs/HMD_xregopose_fusion_concat128'
