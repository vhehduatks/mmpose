"""
ViT-Style Lifting Head v1 - Smoke Test Config

v1: Separate Deconv path (heatmap independent from lifting)
...
model = dict(
    ...
    head=dict(
        ...
        heatmap_size=47,
        use_hmd=True,
        # ===== v1: Separate Deconv path =====
        use_heatmap_recon=False,
        use_separate_deconv=True,
...
work_dir = 'work_dirs/HMD_xregopose_vit_lifting_v1_small'
