"""Task 38 P1 (kinect) — derived from HMD_kinect_v5_flag_cascaded_ground_info_10ep_config.py; changes: head arm params + work_dir only.
"""
IS_WINDOWS = False
_batch_size = 16
_max_epochs = 10
...
work_dir = 'work_dirs/HMD_kinect_v5_gbh_p1'
