"""
Attention-based Lifting Head v4 - SMOKE TEST Config
- LR 0.001 + CosineAnnealing (no warmup)
- Gradient clipping
...
# Optimizer: LR=0.001 + Gradient Clipping
optim_wrapper = dict(
    optimizer=dict(lr=0.001, type='AdamW', weight_decay=0.01),
    clip_grad=dict(max_norm=1.0, norm_type=2),
)

# LR Schedule: CosineAnnealing (simplified for 1 epoch)
param_scheduler = [
    dict(
...
work_dir = 'work_dirs/HMD_xregopose_attention_lifting_v4_small'
