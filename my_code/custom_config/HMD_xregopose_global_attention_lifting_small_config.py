"""
Global Context Enhanced Attention Lifting - Smoke Test Config
...
Architecture:
    K/V: [Backbone tokens [64, D] + Global Token [1, D]] = [65, D]
    Q: Joint tokens [16, D]

    Each joint can attend to:
    1. Spatial backbone features (local depth cues)
    2. Global heatmap context (overall body configuration)
...
# =============================================================================
# Model - Global Attention Lifting Head
# =============================================================================
model = dict(
    ...
    head=dict(
        type='CustomEgoposeGlobalAttentionLiftingHead',
        in_channels=2048,
        out_channels=16,
        decoder=codec,
        # Attention params
...
work_dir = 'work_dirs/HMD_xregopose_global_attention_lifting_small'
