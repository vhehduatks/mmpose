"""
Fusion ablation: cross-attention (z queries hmd), 64-dim output
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_fusion_ablation_crossattn'),
...
work_dir = 'work_dirs/HMD_xregopose_fusion_crossattn'
