"""
Cascaded Refinement + Hand From Ground V3 (Body-Axis Fix)

Ground Info Ablation: HANDS ONLY
- EnhanceHMDInfo mode: 'hand_from_ground' (11-dim = 9 base + 2 hand heights)
- Uses FIXED body-axis method (not Y-axis)

This experiment tests whether hand heights alone are sufficient for ground reference.

Comparison:
- head_from_ground: 10-dim
- hand_from_ground: 11-dim (this config)
...
train_pipeline = [
    ...
    dict(type='EnhanceHMDInfo', mode='hand_from_ground'),
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(project='mmpose_xregopose_ground_ablation_v3_hand_only'),
...
visualizer = dict(
    ...
    ground_info_mode='hand_from_ground',
    vis_backends=vis_backends
)

work_dir = 'work_dirs/HMD_xregopose_cascaded_hand_from_ground_v3_full'
