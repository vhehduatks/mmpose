"""
Skeleton Graph Attention Network - Smoke Test Config
...
- LR=0.0005
- MultiStepLR [4, 7] (not used in 1 epoch, but consistent)
...
# =============================================================================
# LR Schedule: Simplified for smoke test
# =============================================================================
param_scheduler = [
    dict(
        type='MultiStepLR',
...
model = dict(
    ...
    head=dict(
        ...
        use_second_order=True,  # Include 2-hop neighbors
...
work_dir = 'work_dirs/HMD_xregopose_skeleton_gat_small'
