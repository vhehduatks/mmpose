"""
preprocessing_egodataset_weightmodify_intrinsic_ver3_blend - Single-Stage + No-HMD (vision-only) (10 epochs)
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            project='kinect_v3-blend-no-hmd-vision-only',
            name='HMD_kinect_v3_no_hmd_10ep',
            tags=['kinect_v3', 'no_hmd', '10ep'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_kinect_v3_no_hmd_10ep'
