"""
Mo2Cap2 Cascaded Refinement + BOTH FROM GROUND V2 (Lower LR)
...
Changes from V1:
  - lr: 0.0005 → 0.00025 (half learning rate for more stable training)
...
val_cfg = dict()
test_cfg = dict()  # Enable testing

optim_wrapper = dict(
    optimizer=dict(lr=0.00025, type='AdamW'),  # Changed from 0.0005 to 0.00025
)
...
# Test uses same dataloader and evaluator as validation
...
vis_backends = [
    ...
    dict(
        ...
        init_kwargs=dict(
            ...
            name='cascaded_BOTH_from_ground_v2_lr0.00025',
            tags=['mo2cap2', 'cascaded', 'both_from_ground', 'lr_0.00025'],
        ),
    ),
]
...
work_dir = 'work_dirs/HMD_mo2cap2_cascaded_both_from_ground_v2'
