...
default_hooks = dict(
	...
	visualization=dict(type='PoseVisualizationHook', enable=True, interval = 5,kpt_thr=0.3),
	)
...
# model
codec = dict(
    type='Custom_MSRAHeatmap', input_size=(192, 256), heatmap_size=(48, 64), sigma=2)
...
# ---
# mo2cap2 dataset
# ann_file_val = r'F:\mo2cap2_data_temp_extracted\TrainSet'
...
train_dataloader = dict(
    ...
    dataset=dataset_unity_coco_train)
...
val_dataloader = dict(
    ...
    dataset=dataset_unity_coco_val
	)
