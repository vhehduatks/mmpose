"""Task 38 P2 (kinect) — derived from HMD_kinect_v5_flag_cascaded_ground_info_10ep_config.py; changes: head arm params + work_dir only.
"""
custom_imports = dict(
...
work_dir = 'work_dirs/HMD_kinect_v5_gbh_p2'
