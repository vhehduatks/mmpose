"""
Smoke test: Cascaded + GBH + Depth Enhancement.

Verifies that the full training pipeline runs correctly:
  - LoadDepthFromH5Cache loads depth
  - depth_map is packed into gt_instance_labels
  - DepthEncoder + grid-sample + RefinementMLP forward/backward works
  - No shape mismatches or device errors

Settings: max_epochs=1, no checkpoint saving, small batch, val_interval=1.
"""
...
work_dir = 'work_dirs/HMD_xregopose_cascaded_gbh_depth_small'
