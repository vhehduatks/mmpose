...
class CustomEgoposeDataset_seg_depth(BaseDataset):
	...
	def load_data_list(self) -> List[dict]:
		...
		data_list = []
		for img_path, json_path, depth_path, objectId_path in zip(self.index['rgba'], self.index['json'], self.index['depth'], self.index['objectId']):
	...
	def parse_data_info(self, img_path, json_path, depth_path, objectId_path) -> Union[dict, List[dict]]:
