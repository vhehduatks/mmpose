dataset_info = dict(
    ...
    paper_info=dict(
   	...
   	keypoint_info = {
		...
		0: dict(name='Spine2', id=3, color=[51, 153, 255], type='upper', swap=''),
		# 4: dict(name='Neck', id=4, color=[0, 255, 0], type='upper', swap=''),
		1: dict(name='Head', id=5, color=[51, 153, 255], type='', swap=''),
		...
		3: dict(name='LeftForeArm', id=8, color=[0, 255, 0], type='upper', swap='RightForeArm'),
		4: dict(name='LeftHand', id=9, color=[0, 255, 0], type='upper', swap='RightHand'),
		...
		6: dict(name='RightForeArm', id=12, color=[255, 128, 0], type='upper', swap='LeftForeArm'),
		7: dict(name='RightHand', id=13, color=[255, 128, 0], type='upper', swap='LeftHand'),

		8: dict(name='LeftUpLeg', id=14, color=[51, 153, 255], type='lower', swap='RightUpLeg'),
		9: dict(name='LeftLeg', id=15, color=[0, 255, 0], type='lower', swap='RightLeg'),
		10: dict(name='LeftFoot', id=16, color=[0, 255, 0], type='lower', swap='RightFoot'),
		11: dict(name='LeftToeBase', id=17, color=[0, 255, 0], type='lower', swap='RightToeBase'),

		12: dict(name='RightUpLeg', id=18, color=[51, 153, 255], type='lower', swap='LeftUpLeg'),
	...
	skeleton_info = {
		...
		2: dict(link=('LeftArm', 'LeftForeArm'), id=5, color=[0, 255, 0]),
		3: dict(link=('LeftForeArm', 'LeftHand'), id=6, color=[0, 255, 0]),
		# 7: dict(link=('Neck', 'RightShoulder'), id=7, color=[51, 153, 255]),
		4: dict(link=('Spine2', 'RightArm'), id=8, color=[51, 153, 255]),
		5: dict(link=('RightArm', 'RightForeArm'), id=9, color=[255, 128, 0]),
		6: dict(link=('RightForeArm', 'RightHand'), id=10, color=[255, 128, 0]),

		7: dict(link=('Spine2', 'LeftUpLeg'), id=11, color=[51, 153, 255]),
		8: dict(link=('LeftUpLeg', 'LeftLeg'), id=12, color=[0, 255, 0]),
		9: dict(link=('LeftLeg', 'LeftFoot'), id=13, color=[0, 255, 0]),
		10: dict(link=('LeftFoot', 'LeftToeBase'), id=14, color=[0, 255, 0]),

		11: dict(link=('Spine2', 'RightUpLeg'), id=15, color=[51, 153, 255]),
		12: dict(link=('RightUpLeg', 'RightLeg'), id=16, color=[255, 128, 0]),
		13: dict(link=('RightLeg', 'RightFoot'), id=17, color=[255, 128, 0]),
		14: dict(link=('RightFoot', 'RightToeBase'), id=18, color=[255, 128, 0]),
	},
    joint_weights=[
